...
namespace SimpleShop.Domain.Migrations
{
    ...
    [Migration("20240110094455_AddCategoryCoach")]
    partial class AddCategoryCoach
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleShop.Domain.Entities.CategoryCoach", b =>
                {
                    b.Property<int>("CoachId")
                        .HasColumnType("integer");

                    b.Property<int>("CategoryPeopleId")
                        .HasColumnType("integer");

                    b.HasKey("CoachId", "CategoryPeopleId");

                    b.HasIndex("CategoryPeopleId");

                    b.ToTable("CategoryCoaches");
                });

            modelBuilder.Entity("SimpleShop.Domain.Entities.CategoryPeople", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SimpleShop.Domain.Entities.Coach", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SimpleShop.Domain.Entities.CategoryCoach", b =>
                {
                    b.HasOne("SimpleShop.Domain.Entities.CategoryPeople", "CategoryPeople")
                        .WithMany()
                        .HasForeignKey("CategoryPeopleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SimpleShop.Domain.Entities.Coach", "Coach")
                        .WithMany()
                        .HasForeignKey("CoachId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CategoryPeople");
