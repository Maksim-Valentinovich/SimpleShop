        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountVisit = table.Column<int>(type: "integer", nullable: true),
                    CountPeople = table.Column<int>(type: "integer", nullable: true),
                    CountDay = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscriptions", x => new { x.ProductId, x.OrderId });
                    table.ForeignKey(
