...
namespace SimpleShop.Mvc
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Сервисы можно просто ручками добавить в отдельном методе, и не нужно будет лепить ненужный IApplicationService
            ...
            app.UseStaticFiles();
            // ненужные комменты не оставляем в гите, относится ко всем подобным
